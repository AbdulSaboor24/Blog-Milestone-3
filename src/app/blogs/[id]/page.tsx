    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-6 py-12">
        ...
        {blog.blogimage?.asset?.url && (
          <div className="relative w-full h-80 md:h-[500px] overflow-hidden rounded-lg shadow-md">
            <Image
        ...
        {/* Blog Content */}
        <div className="mt-6 prose prose-lg prose-indigo mx-auto">
        ...
        {/* Author Info */}
        {author && (
          <div className="mt-10 flex items-center border-t pt-6">
            <img
        ...
        <div className="mt-12">
          ...
          {/* Display Comments (conditionally on client-side only) */}
          {comments.length > 0 ? (
